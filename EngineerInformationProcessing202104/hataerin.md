...
### 💡[7-33] 트랜잭션의 특성 중 일관성, 지속성 외 2개의 특성을 쓰시오. 
...
(2) 격리성
  ...
  ##### 해설
    ...
    - 격리성(또는 고립성)은 트랜잭션 실행 중 생성하는 연산의 중간  결과를 다른 트랜잭션이 접근 불가한 특성이다. 

</div> </details>



### 💡[7-34] 09. 학생 테이블에 주소 속성을 추가하는 SQL문을 작성하시오 
...
(2) ADD
  ...
  ##### 해설
    ...
    - ALTER TABLE에서 컬럼추가하기 위한 문법은 다음과 같다.
